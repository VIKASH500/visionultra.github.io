  ...
  return (
    <div className="max-w-md mx-auto glass p-6 rounded-lg">
      ...
      <form className="space-y-4">
        <label className="block"><span className="text-sm text-slate-700 dark:text-slate-300">Full name</span><input required className="mt-1 w-full px-3 py-2 rounded border"/></label>
